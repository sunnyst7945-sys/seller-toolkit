...
(function (root, factory) {
  ...
  var HS_CODES = [
    ...
    { code: '3304990099', cn: '其他美容品或化妆品及护肤品（面霜、防晒等）', en: 'Other beauty or make-up preparations and skin care' },
    { code: '3305100090', cn: '洗发剂', en: 'Shampoos' },
    ...
    { code: '3306101090', cn: '洁齿品（牙膏）', en: 'Dentifrices' },
    ...
    { code: '3926200000', cn: '塑料制衣服及衣着附件', en: 'Articles of apparel and clothing accessories of plastics' },
    { code: '3926909090', cn: '其他塑料制品', en: 'Other articles of plastics' },
    { code: '3919109900', cn: '塑料制自粘胶带（宽度≤20cm）', en: 'Self-adhesive plates, sheets, film, foil, tape of plastics, rolls ≤20cm' },
    // 第42章 箱包
    { code: '4202119000', cn: '皮革、再生皮革或漆皮作面的衣箱、手提箱', en: 'Trunks, suitcases with outer surface of leather' },
    ...
    { code: '4203100090', cn: '皮革制衣服', en: 'Articles of apparel, of leather' },
    { code: '4203301090', cn: '皮革制腰带', en: 'Belts and bandoliers, of leather' },
    // 第61章 针织服装
    { code: '6109100021', cn: '棉制针织或钩编T恤衫、汗衫', en: 'T-shirts, singlets and other vests, of cotton, knitted' },
    { code: '6109909021', cn: '其他纺织材料制T恤衫', en: 'T-shirts of other textile materials, knitted' },
    { code: '6110200012', cn: '棉制针织或钩编套头衫、开襟衫', en: 'Sweaters, pullovers, cardigans of cotton, knitted' },
    { code: '6110300012', cn: '化学纤维制针织套头衫', en: 'Sweaters of man-made fibres, knitted' },
    { code: '6111200090', cn: '棉制婴儿服装及衣着附件', en: 'Babies garments and clothing accessories, of cotton, knitted' },
    { code: '6115950019', cn: '棉制袜子', en: 'Stockings, socks of cotton, knitted' },
    { code: '6103430090', cn: '合成纤维制男式长裤', en: 'Men trousers of synthetic fibres, knitted' },
    { code: '6104620090', cn: '棉制女式长裤', en: 'Women trousers of cotton, knitted' },
    { code: '6104630090', cn: '合成纤维制女式长裤', en: 'Women trousers of synthetic fibres, knitted' },
    // 第62章 梭织服装
    { code: '6203429099', cn: '棉制男式长裤', en: 'Men trousers of cotton, not knitted' },
    { code: '6203439090', cn: '合成纤维制男式长裤', en: 'Men trousers of synthetic fibres, not knitted' },
    { code: '6204620099', cn: '棉制女式长裤', en: 'Women trousers of cotton, not knitted' },
    { code: '6204630090', cn: '合成纤维制女式长裤', en: 'Women trousers of synthetic fibres, not knitted' },
    { code: '6204430090', cn: '合成纤维制女式连衣裙', en: 'Women dresses of synthetic fibres, not knitted' },
    { code: '6204420090', cn: '棉制女式连衣裙', en: 'Women dresses of cotton, not knitted' },
    { code: '6205200099', cn: '棉制男式衬衫', en: 'Men shirts of cotton, not knitted' },
    { code: '6205300099', cn: '化学纤维制男式衬衫', en: 'Men shirts of man-made fibres, not knitted' },
    { code: '6206300090', cn: '棉制女式衬衫', en: 'Women blouses of cotton, not knitted' },
    { code: '6206400090', cn: '化学纤维制女式衬衫', en: 'Women blouses of man-made fibres, not knitted' },
    { code: '6212101000', cn: '胸罩', en: 'Brassieres' },
    { code: '6211430090', cn: '化学纤维制女式运动服及其他服装', en: 'Women other garments of man-made fibres' },
    { code: '6202939090', cn: '化学纤维制女式防风夹克', en: 'Women wind-jackets of man-made fibres' },
    // 第64章 鞋
    { code: '6402992900', cn: '其他橡胶或塑料制外底及鞋面的鞋靴', en: 'Other footwear with outer soles and uppers of rubber or plastics' },
    { code: '6403190090', cn: '橡胶/塑料外底、皮革鞋面的运动鞋靴', en: 'Sports footwear with rubber/plastic sole and leather upper' },
    { code: '6403990090', cn: '其他橡胶/塑料或皮革外底、皮革鞋面的鞋靴', en: 'Other footwear with leather uppers' },
    { code: '6404110000', cn: '橡胶/塑料外底、纺织材料鞋面的运动鞋靴', en: 'Sports footwear; tennis shoes, textile uppers' },
    { code: '6404199000', cn: '橡胶/塑料外底、纺织材料鞋面的其他鞋靴', en: 'Other footwear with textile uppers' },
    { code: '6404209000', cn: '皮革外底、纺织材料鞋面的鞋靴', en: 'Footwear with leather sole and textile uppers' },
    // 第71章 首饰
    { code: '7113119000', cn: '银制首饰及其零件', en: 'Jewellery of silver' },
    { code: '7113191900', cn: '其他贵金属制首饰及其零件', en: 'Jewellery of other precious metal' },
    ...
    { code: '7326909000', cn: '其他钢铁制品', en: 'Other articles of iron or steel' },
    { code: '7615109000', cn: '铝制餐桌、厨房或其他家用器具', en: 'Table, kitchen or household articles of aluminium' },
    // 第82章 工具
    { code: '8211910000', cn: '刃面固定的餐刀', en: 'Table knives having fixed blades' },
    { code: '8211920000', cn: '其他刃面固定的刀', en: 'Other knives having fixed blades' },
    { code: '8212100000', cn: '剃刀', en: 'Razors' },
    // 第84章 机械
    { code: '8471309000', cn: '便携式自动数据处理设备（笔记本电脑、平板）', en: 'Portable automatic data processing machines' },
    { code: '8471419000', cn: '其他自动数据处理设备（台式电脑）', en: 'Other automatic data processing machines' },
    { code: '8471607100', cn: '输入或输出部件（键盘、鼠标）', en: 'Input or output units' },
    { code: '8443319090', cn: '多功能打印机（打印、复印、传真）', en: 'Machines performing two or more functions of printing' },
    { code: '8415102100', cn: '窗式或壁式空调', en: 'Air conditioning machines, window or wall types' },
    // 第85章 电器
    { code: '8504401400', cn: '静止式变流器（充电器、电源适配器）', en: 'Static converters (chargers, power adapters)' },
    { code: '8507600090', cn: '锂离子蓄电池', en: 'Lithium-ion accumulators' },
    { code: '8509809000', cn: '其他家用电动器具', en: 'Other electro-mechanical domestic appliances' },
    { code: '8517121090', cn: '智能手机', en: 'Smartphones' },
    { code: '8517629990', cn: '接收、转换、发送或再生数据设备（路由器等）', en: 'Machines for the reception, conversion and transmission of data' },
    { code: '8518210000', cn: '单喇叭音箱', en: 'Single loudspeakers, mounted in their enclosures' },
    { code: '8518220000', cn: '多喇叭音箱', en: 'Multiple loudspeakers, mounted in the same enclosure' },
    { code: '8518300000', cn: '耳机、耳塞及头戴受话器', en: 'Headphones and earphones' },
    { code: '8519813100', cn: '使用半导体媒体的声音录制或重放设备', en: 'Sound recording or reproducing apparatus' },
    { code: '8523510090', cn: '固态非易失性存储器件（U盘/存储卡）', en: 'Solid-state non-volatile storage devices' },
    { code: '8525801300', cn: '数字照相机及摄录一体机', en: 'Digital cameras and video camera recorders' },
    { code: '8528521200', cn: '可直接连接自动数据处理设备的显示器', en: 'Monitors directly connected to automatic data processing machines' },
    { code: '8528722200', cn: '彩色电视接收机', en: 'Reception apparatus for television, colour' },
    { code: '8536500000', cn: '其他开关（电压≤1000V）', en: 'Other switches' },
    { code: '8536690000', cn: '插头及插座', en: 'Plugs and sockets' },
    { code: '8544421100', cn: '带接头的数据线、连接线', en: 'Electric conductors fitted with connectors' },
    { code: '8544491900', cn: '其他电线电缆', en: 'Other electric conductors' },
    // 第90章 光学
    { code: '9004100000', cn: '太阳镜', en: 'Sunglasses' },
    { code: '9004909000', cn: '其他眼镜、护目镜及类似品（含矫正眼镜）', en: 'Other spectacles, goggles and the like' },
    { code: '9019101000', cn: '按摩器具', en: 'Mechano-therapy appliances; massage apparatus' },
    { code: '9025191000', cn: '温度计（未与其他仪器组合）', en: 'Thermometers, not combined with other instruments' },
    // 第91章 钟表
    ...
    { code: '9102210000', cn: '其他机械手表', en: 'Other wrist-watches, mechanically operated' },
    { code: '9105210000', cn: '电动挂钟', en: 'Wall clocks, electrically operated' },
    // 第94章 家具灯具
    { code: '9403200000', cn: '金属制其他家具', en: 'Other metal furniture' },
    { code: '9403300090', cn: '办公用木家具', en: 'Wooden furniture of a kind used in offices' },
    { code: '9403400090', cn: '厨房用木家具', en: 'Wooden furniture of a kind used in the kitchen' },
    { code: '9403509900', cn: '卧室用木家具', en: 'Wooden furniture of a kind used in the bedroom' },
    { code: '9403609900', cn: '其他木家具', en: 'Other wooden furniture' },
    { code: '9404290000', cn: '其他材料制褥垫', en: 'Mattresses of other materials' },
    { code: '9404904000', cn: '寝具及类似填充制品（枕头、靠垫）', en: 'Articles of bedding and similar furnishing' },
    ...
    { code: '9405409000', cn: '其他电气灯具及照明装置（LED灯串等）', en: 'Other electric lamps and lighting fittings' },
    // 第95章 玩具运动
    { code: '9503001000', cn: '玩偶', en: 'Dolls' },
    { code: '9503008900', cn: '其他玩具（积木、模型等）', en: 'Other toys (building blocks, models)' },
    { code: '9504400000', cn: '扑克牌', en: 'Playing cards' },
    { code: '9504909000', cn: '其他游戏用品（桌游等）', en: 'Other games' },
    { code: '9505100090', cn: '圣诞节用品', en: 'Articles for Christmas festivities' },
    { code: '9505900000', cn: '其他节日或娱乐用品', en: 'Festive, carnival or other entertainment articles' },
    { code: '9506110000', cn: '滑雪板', en: 'Skis' },
    { code: '9506310000', cn: '高尔夫球杆', en: 'Golf clubs' },
    { code: '9506510000', cn: '网球拍', en: 'Lawn-tennis rackets' },
    { code: '9506629000', cn: '充气球', en: 'Inflatable balls' },
    { code: '9506919000', cn: '健身器械（哑铃、跑步机等）', en: 'Articles and equipment for general physical exercise' },
    { code: '9506990000', cn: '其他运动用品', en: 'Other articles for sports' },
    // 第96章 杂项
    { code: '9603210000', cn: '牙刷', en: 'Tooth brushes' },
    { code: '9603309090', cn: '化妆刷、粉扑及类似化妆用刷', en: 'Cosmetic brushes and pads' },
    { code: '9603909000', cn: '其他刷、帚', en: 'Other brushes' },
    { code: '9607200000', cn: '拉链零件', en: 'Parts of slide fasteners' },
    ...
    { code: '9619001090', cn: '卫生巾、婴儿尿布等（卫生用品）', en: 'Sanitary towels, napkins and diapers' }
  ];
